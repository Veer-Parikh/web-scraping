    ...
    try:
        ...
        for index in range(total_buttons):
            try:
                ...
                # Scraping Promoter, CEO, and Bank Account Details
                    ...
                    try:
                        ...
                        for i in range(0, len(cols), 2):
                            ...
                            if 'promoter name' in label:
                                ...
                                data["Taluk"] = value
                            elif 'authorized signatory' in label or 'ceo' in label or 'md' in label:
        ...
        with open('promoter_and_ceo_details.csv', 'w', newline='', encoding='utf-8') as file:
            fieldnames = ["Promoter Name", "Registration Number", "PAN", "GSTIN", "District", "Taluk", "CEO/MD Name", "Designation", "CEO/MD PAN", "DIN", "Account Name", "Bank Name"]
