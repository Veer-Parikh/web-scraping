...
try:
    ...
    while True:
        ...
        scrape_page(page_count)

        # Try to find and click the "Next" button for the next page
        try:
            next_button = driver.find_element(By.XPATH, f'//a[@data-p="{page_count + 1}" and contains(@class, "ds4u-pager-btn")]')
            next_button.click()
