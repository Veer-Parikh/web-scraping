...
# Function to select the year and submit the form
def select_year_and_submit(year):
    try:
        # Select the dropdown
        year_dropdown = driver.find_element(By.ID, "year")
        year_dropdown.click()

        # Choose the "2024" option
        ...
        time.sleep(3)
        print(f"Selected year {year} and submitted.")
    except Exception as e:
        print(f"Error selecting year and submitting: {e}")
...
try:
    ...
    # Select "2024" and click Submit
    select_year_and_submit("2024")
